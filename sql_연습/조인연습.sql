...
select a.emp_no as 사번, a.first_name as 직원이름, c.dept_name as 부서이름
from employees a
...
select a.title as 직책, avg(b.salary) as 평균연봉, count(b.emp_no) as 직원수
from titles a
...
-- 실습문제3
-- 현재, 부서별로 직책이 Engineer인 직원에 대해서만 평균연봉을 구함
-- 부서이름, 평균급여로 출력하고 평균연봉이 높은 순으로 정렬
